...
# Partitions
BOARD_USERDATAIMAGE_PARTITION_SIZE := 243025293312
ifneq ($(WITH_GMS),true)
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 2630733824
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 633966592
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 654090240
endif
